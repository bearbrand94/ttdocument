  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="request_ttd()">Kirim</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<script type="text/javascript">
    ...
    function validate_input(){
        // alert("A");
        var flag_error=0;
        var message="Gagal membuat TTD Baru karena terdapat beberapa kesalahan sebagai berikut:<br>";
        if(arrDocument.length <= 0){
            flag_error=1;
            message += "-Dokumen Harus Ada Minimal 1.<br>"
        }
